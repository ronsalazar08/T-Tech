...
class SaleUpdateView(SuccessMessageMixin, UpdateView):
    ...
    success_message = 'Updating RBF <strong>%(name)s</strong> Sales Successfull!'
    fields = ('name', 'amount')
...
class RfpgUpdateView(SuccessMessageMixin, UpdateView):
    ...
    success_message = 'Updating RBF <strong>%(name)s</strong> Rfpgs Successfull!'
